...
def write_campaign_report(db_path: str | Path | None, output_path: str | Path = "campaign_report.md", summary: dict | None = None) -> dict:
    ...
    try:
        ...
        body = [
            ...
            f"- tracer_preflight_total_rows: {report.get('tracer_preflight_total_rows', notes.get('tracer_preflight_total_rows', 0))}",
            f"- tracer_preflight_raw_rows_read_count: {report.get('tracer_preflight_raw_rows_read_count', notes.get('tracer_preflight_raw_rows_read_count', 0))}",
            f"- tracer_preflight_eligible_count: {report.get('tracer_preflight_eligible_count', notes.get('tracer_preflight_eligible_count', 0))}",
            f"- tracer_preflight_missing_status_count: {report.get('tracer_preflight_missing_status_count', notes.get('tracer_preflight_missing_status_count', 0))}",
            f"- tracer_preflight_missing_brand_name_count: {report.get('tracer_preflight_missing_brand_name_count', notes.get('tracer_preflight_missing_brand_name_count', 0))}",
            f"- tracer_preflight_missing_website_count: {report.get('tracer_preflight_missing_website_count', notes.get('tracer_preflight_missing_website_count', 0))}",
            f"- tracer_preflight_brand_filtered_count: {report.get('tracer_preflight_brand_filtered_count', notes.get('tracer_preflight_brand_filtered_count', 0))}",
            f"- tracer_preflight_duplicate_rows_skipped: {report.get('tracer_preflight_duplicate_rows_skipped', notes.get('tracer_preflight_duplicate_rows_skipped', 0))}",
            f"- tracer_preflight_junk_rows_skipped: {report.get('tracer_preflight_junk_rows_skipped', notes.get('tracer_preflight_junk_rows_skipped', 0))}",
            f"- tracer_preflight_missing_requested_brands: {json.dumps(report.get('tracer_preflight_missing_requested_brands', notes.get('tracer_preflight_missing_requested_brands', [])), ensure_ascii=False)}",
            f"- tracer_preflight_read_source: {report.get('tracer_preflight_read_source', notes.get('tracer_preflight_read_source', ''))}",
            f"- tracer_preflight_sheet_read_error_count: {report.get('tracer_preflight_sheet_read_error_count', notes.get('tracer_preflight_sheet_read_error_count', 0))}",
            f"- tracer_preflight_error: {report.get('tracer_preflight_error', notes.get('tracer_preflight_error', ''))}",
            f"- tracer_preflight_missing_required_fields_by_row: {json.dumps(report.get('tracer_preflight_missing_required_fields_by_row', notes.get('tracer_preflight_missing_required_fields_by_row', [])), ensure_ascii=False)}",
            f"- tracer_preflight_matching_rows_by_brand: {json.dumps(report.get('tracer_preflight_matching_rows_by_brand', notes.get('tracer_preflight_matching_rows_by_brand', {})), sort_keys=True)}",
            f"- tracer_preflight_selected_rows_by_brand: {json.dumps(report.get('tracer_preflight_selected_rows_by_brand', notes.get('tracer_preflight_selected_rows_by_brand', {})), sort_keys=True)}",
            f"- tracer_preflight_final_brands_to_process: {json.dumps(report.get('tracer_preflight_final_brands_to_process', notes.get('tracer_preflight_final_brands_to_process', [])), ensure_ascii=False)}",
            f"- tracer_brands_requested: {json.dumps(report.get('tracer_brands_requested', notes.get('tracer_brands_requested', [])), ensure_ascii=False)}",
