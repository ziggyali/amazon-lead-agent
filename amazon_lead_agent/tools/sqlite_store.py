...
def _lead_row(lead: dict) -> dict:
    ...
    row = {
        ...
        "extraction_error": lead.get("extraction_error", ""),
        "scrapegraph_error": lead.get("scrapegraph_error", ""),
        "llm_provider_used": lead.get("llm_provider_used", ""),
